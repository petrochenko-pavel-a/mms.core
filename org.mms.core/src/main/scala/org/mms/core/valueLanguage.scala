...
case object ThisValue extends ValueModel
case class OldValue(pr:PropertyModel) extends ValueModel
case class NewValue(pr:PropertyModel) extends ValueModel

case class Add[T<:Type](pr:PropertyModel,base:ValueModel,v:ValueModel) extends PropertyModification
case class Remove[T<:Type](pr:PropertyModel,base:ValueModel,v:ValueModel) extends PropertyModification
